...
ririn = LINE("EtBdENEnOz2WAxvEcAW7.2cE5x4rOXg4WZ5V13txO5W.3uhXlE0dzft8Z3E1bR83qt4V6AOkj0T50qTcDEX2zPs=")
#ririn = LINE("TOKENMU")
...
#------------------------------------============================------------------------------------#
                            if cmd == "backup profile":
                                try:
                                    ...
                                    ririn.sendMessage(to, "ʙᴀᴄᴋᴜᴘ ᴘʀᴏғɪʟᴇ sᴜᴄᴄᴇs",'Backup Profile.','http://line.me/ti/p/ppgIZ0JLDW','https://preview.ibb.co/dpBpCd/20180601_164057.png')
                                except Exception as e:
                                    ririn.sendMessage(to, "ʙᴀᴄᴋᴜᴘ ᴘʀᴏғɪʟᴇ ғᴀɪʟᴇᴅ",'Backup Profile.','http://line.me/ti/p/ppgIZ0JLDW','https://preview.ibb.co/dpBpCd/20180601_164057.png')
                                    logError(error)
                                ...
                                try:
                                    ...
                                    ririn.sendMessage(to, "ʀᴇsᴛᴏʀᴇ ᴘʀᴏғɪʟᴇ sᴜᴄᴄᴇs, ᴡᴀɪᴛ ᴀ ғᴇᴡ ᴍɪɴᴜᴛᴇs",'Restore Profile.','http://line.me/ti/p/ppgIZ0JLDW','https://preview.ibb.co/dpBpCd/20180601_164057.png')
                                except Exception as e:
                                    ririn.sendMessage(to, "ʀᴇsᴛᴏʀᴇ ᴘʀᴏғɪʟᴇ ғᴀɪʟᴇᴅ",'Restore Profile.','http://line.me/ti/p/ppgIZ0JLDW','https://preview.ibb.co/dpBpCd/20180601_164057.png')
                                    logError(error)
                                ...
                                if len(string) <= 500:
                                    ...
                                    ririn.sendMessage(to,"ᴄʜᴀɴɢᴇ ᴘʀᴏғɪʟᴇ sᴜᴄᴄᴇs :{}".format(str(string)),'Change Bio.','http://line.me/ti/p/ppgIZ0JLDW','https://preview.ibb.co/dpBpCd/20180601_164057.png')
                            elif cmd == "change pictureprofile":
                            	wait["changePictureProfile"] = True
                            	ririn.sendMessage(to, "sᴇɴᴅ ᴘɪᴄᴛᴜʀᴇ",'Change Picture Profile.','http://line.me/ti/p/ppgIZ0JLDW','https://preview.ibb.co/dpBpCd/20180601_164057.png')
                            elif cmd == "change dual": 
                                ririn.sendMessageWithContent(to, "ᴘᴇʀɪɴᴛᴀʜ ɪɴɪ ʜᴀɴʏᴀ ʙɪsᴀ ᴅɪᴀᴋsᴇs ᴏʟᴇʜ ᴄʀᴇᴀᴛᴏʀ ᴅɴᴀ",'Change Dual.','http://line.me/ti/p/ppgIZ0JLDW','https://preview.ibb.co/dpBpCd/20180601_164057.png')
                                changeVideoAndPictureProfile('image.jpg', 'video.mp4')
                            elif cmd.startswith("change name:"):
                                sep = text.split(" ")
                                string = text.replace(sep[0] + " ","")
                                if len(string) <= 20:
                                    profile = ririn.getProfile()
                                    ...
                                    ririn.updateProfile(profile)
                                    ririn.sendMessage(to,"ᴄʜᴀɴɢᴇ ɴᴀᴍᴇ sᴜᴄᴄᴇs :{}".format(str(string)),'Change Name.','http://line.me/ti/p/ppgIZ0JLDW','https://preview.ibb.co/dpBpCd/20180601_164057.png')
                                ...
                                if 'MENTION' in msg.contentMetadata.keys()!= None:
                                    ...
                                    for ls in lists:
                                        ...
                                        ririn.sendMessage(to, "ᴄʟᴏɴᴇ ᴘʀᴏғɪʟᴇ sᴜᴄᴄᴇs : {}".format(contact.displayName),'Clone Profile.','http://line.me/ti/p/ppgIZ0JLDW','https://preview.ibb.co/dpBpCd/20180601_164057.png')
                            elif cmd == "me":
                                ririn.sendContact(to, sender)
                            elif cmd == "mymid":
                                ririn.sendMessage(to, "[ ᴍɪᴅ ]\n{}".format(sender),'Mid.','http://line.me/ti/p/ppgIZ0JLDW','https://preview.ibb.co/dpBpCd/20180601_164057.png')
                            elif cmd == "myname":
                                contact = ririn.getContact(sender)
                                ririn.sendMessage(to, "[ ᴅɪsᴘʟᴀʏ ɴᴀᴍᴇ ]\n{}".format(contact.displayName),'Name.','http://line.me/ti/p/ppgIZ0JLDW','https://preview.ibb.co/dpBpCd/20180601_164057.png')
                            elif cmd == "mybio":
                                contact = ririn.getContact(sender)
                                ririn.sendMessage(to, "[ sᴛᴀᴛᴜs ᴍᴇssᴀɢᴇ ]\n{}".format(contact.statusMessage),'Bio.','http://line.me/ti/p/ppgIZ0JLDW','https://preview.ibb.co/dpBpCd/20180601_164057.png')
                            elif cmd == "mypicture":
                                contact = ririn.getContact(sender)
                                ...
                                if 'MENTION' in msg.contentMetadata.keys()!= None:
                                    ...
                                    for ls in lists:
                                        ...
                                        ririn.sendMessage(to, "[ sᴛᴀᴛᴜs ᴍᴇssᴀɢᴇ ]\n{}".format(str(contact.statusMessage)),contentMetadata = {'AGENT_ICON': 'http://dl.profile.line.naver.jp/{}'.format(contact.pictureStatus), 'AGENT_NAME': cName, 'AGENT_LINK': '{}'.format(str(contact.statusMessage))})
                                        #'Steal Bio.','http://line.me/ti/p/{}','http://dl.profile.line.naver.jp/{}'.format(contact.displayName))
...
#------------------------------------============================------------------------------------#
                            if cmd == "restart":
                                ...
                                ririn.sendMessageWithContent(to, "ʀᴜɴɴɪɴɢ ɪɴ.. {}".format(str(runtime)),'Runtime.','http://line.me/ti/p/ppgIZ0JLDW','https://preview.ibb.co/dpBpCd/20180601_164057.png')
                            elif cmd == "sp":
                        ...
                        if text.lower() == "mykey":
                            ririn.sendMessageWithContent(to, "ᴋᴇʏᴄᴏᴍᴍᴀɴᴅ sᴀᴀᴛ ɪɴɪ [ {} ]".format(str(wait["keyCommand"])),'My Key.','http://line.me/ti/p/ppgIZ0JLDW','https://preview.ibb.co/dpBpCd/20180601_164057.png')
                        elif text.lower() == "setkey on":
                            wait["setKey"] = True
                            ririn.sendMessageWithContent(to, "ʙᴇʀʜᴀsɪʟ ᴍᴇɴɢᴀᴋᴛɪғᴋᴀɴ sᴇᴛᴋᴇʏ",'Set Key.','http://line.me/ti/p/ppgIZ0JLDW','https://preview.ibb.co/dpBpCd/20180601_164057.png')
                        elif text.lower() == "setkey off":
                            wait["setKey"] = False
                            ririn.sendMessageWithContent(to, "ʙᴇʀʜᴀsɪʟ ᴍᴇɴᴏɴᴀᴋᴛɪғᴋᴀɴ sᴇᴛᴋᴇʏ",'Set Key.','http://line.me/ti/p/ppgIZ0JLDW','https://preview.ibb.co/dpBpCd/20180601_164057.png')
