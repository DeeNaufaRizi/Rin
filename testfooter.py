...
ririn = LINE("EtayQq3vXvkFE6oAsFY1.rCWrtE6UfnNgoLxTqXzdSq.D0rm6pwlDgXnxn3hZk5UoBBqVZqiyKzM07129jRuxJM=")
#ririn = LINE("TOKENMU")
                    ...
                    if msg.contentType == 0:
                        if text is None:
                            ...
                            if cmd == "help":
                                ...
                                footer = {'AGENT_LINK': 'line.me/ti/p/ppgIZ0JLDW','AGENT_ICON': "http://dl.profile.line-cdn.net/",'AGENT_NAME':(creator.displayName)}
                                ririn.sendMessage(to, str(helpMessage(footer)))
                                ririn.sendContact(to, "ueca4120a9d7b0e4a9e7f4f1b1b96a436")
                                ririn.sendMessage(to, textx, {'AGENT_LINK': 'line.me/ti/p/ppgIZ0JLDW','AGENT_ICON': "http://dl.profile.line-cdn.net/" + creator.pictureStatus})
                            elif cmd == "tts":
