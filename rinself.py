...
#ririn = LINE("TOKENMU")
ririn = LINE("Et6ZP2C5HykZgrfq27z6.7kqscP17dKQEF08Bg5AKnG.fVCbgYQmB2EkY7u8tGrqiBLRoSPYkqJpabFgTKDN4HM=")
        ...
        if op.type == 26:
            ...
            if wait["autoReply"] == True:
                if msg.toType == 0:                	
                    ...
                    ririn.sendMessage(msg._from,dee,contentMetadata = {'AGENT_ICON': 'https://preview.ibb.co/dpBpCd/20180601_164057.png', 'AGENT_NAME': 'Auto Reply.', 'AGENT_LINK': 'http://line.me/ti/p/ppgIZ0JLDW'})
