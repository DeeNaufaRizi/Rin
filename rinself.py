...
#ririn = LINE("TOKENMU")
ririn = LINE("EtrIqzQ0UCDYg6iWAg41.rCWrtE6UfnNgoLxTqXzdSq.PjplK0yeHkokVkTf5KYTdZo1F2DCpjrM4vHLnJjhi2k=")
                                 ...
                                 #   group.displayName = string
                                  #  ririn.updateGroup(group)
                                   # path = "http://dl.profile.line-cdn.net/" + group.pictureStatus
                                    #group = ririn.getGroup(to)
                                    #gTicket = "https://line.me/R/ti/g/{}".format(str(ririn.reissueGroupTicket(group.id)))
                                   # ririn.sendMessage(to,"ᴄʜᴀɴɢᴇ ɴᴀᴍᴇ sᴜᴄᴄᴇs :{}".format(str(string)),contentMetadata = {'AGENT_ICON': path, 'AGENT_NAME': '{}'.format(str(group.name)), 'AGENT_LINK': '{}'.format(gTicket)})
